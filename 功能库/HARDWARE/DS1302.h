...
#define DS1302_IN  PinIn(DATA_GPIO,DATA_Pin)//PAin(2)
#define DS1302_OUT PinOut(DATA_GPIO,DATA_Pin)//PAout(2)
#define DS1302_RST PinOut(RST_GPIO,RST_Pin)//PAout(0)
#define DS1302_CLK PinOut(SCLK_GPIO,SCLK_Pin)//PAout(1)
