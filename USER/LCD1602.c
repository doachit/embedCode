...
int main(void) 
{
    ...
    while(1)
	{
	LCD1602_Write_Str(0,0,">>>Time Set       ");
	}
	// while(1)   //主循环
	// {
    //     DHT11_Read_Data(&dht11Data.humi_int,&dht11Data.humi_deci,&dht11Data.temp_int,&dht11Data.temp_deci);
    //     fTemp = dht11Data.temp_int + dht11Data.temp_deci*0.1;
    //     fHumi = dht11Data.humi_int + dht11Data.humi_deci*0.1;
